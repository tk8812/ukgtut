  ...
  */
  ...
  public:
	...
	struct Params
	{
		Params() : 
			gravity(0, -9.81f, 0),			
				m_AabbWorld(irr::core::vector3df(-10000,-10000,-10000),irr::core::vector3df(10000,10000,10000))	,
				worldType(EWT_RIGID)
			{}
		int worldType;	
		core::vector3df gravity;
		irr::core::aabbox3df m_AabbWorld;
	} m_worldParam;
	...
	bool InitDynamicsWorld(Params *param);
  ...
  protected:
    ...
    //! Ctor
	CBulletWorldAnimator(CBulletAnimatorManager* bulletMgr,Params *params);
	//CBulletWorldAnimator(CBulletAnimatorManager* bulletMgr,int bSoft,irr::core::vector3df m_WorldAxiesMin,irr::core::vector3df m_WorldAxiesMax);
