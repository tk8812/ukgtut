...
namespace scene
{
  ...
  public:
	...
	//! Create fps cam animator
	CBulletFpsCamAnimator* createBulletFpsCamAnimator(
		ISceneManager* scenemanager, 
		ISceneNode* sceneNode, 
	...
	CBulletWorldAnimator* getBulletWorldBySceneNode(irr::scene::ISceneNode *pNode);
