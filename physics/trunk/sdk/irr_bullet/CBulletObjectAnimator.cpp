...
void CBulletObjectAnimator::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options/*=0*/) const
{
  // store world's id
...
void CBulletObjectAnimator::SerializeIrrMesh(io::IAttributes* out, io::SAttributeReadWriteOptions* options/*=0*/) const
{
